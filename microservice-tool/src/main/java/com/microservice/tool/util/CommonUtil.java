...
import com.microservice.tool.constant.ApplicationNameEnum;
...
import com.microservice.tool.filter.KoalaHttpRequestWrapper;
...
public class CommonUtil {
	 ...
	 * @return null 没有异常
	 */
	public static DataException check(String method, String path, String param, List<String> ignoreCheckUris) {
		//检验路径
