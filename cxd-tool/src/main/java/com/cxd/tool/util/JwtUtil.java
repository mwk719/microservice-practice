...
public class JwtUtil {
	...
	public static Jws<Claims> parseJWT(Key key, String claimsJws) {
		...
		claimsJws = StrUtil.removePrefix(claimsJws, JWT_SEPARATOR);
		//StringUtils.substringAfter(claimsJws, JWT_SEPARATOR);
		// 解析 JWT 字符串
	...
	public static void main(String[] args) {
		String sub = "89084";
		String jti = "13333333333";
		Integer duration = 60;
		String token = buildJWT(sub, jti, duration);
		System.out.println(token);

		boolean flag = checkJWT("Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiI4OTA4NCIsImp0aSI6IjE4ODI5MDM2NjIxIiwiaWF0IjoxNTY5MzA4MjY3LCJleHAiOjE1NjkzMDgzMjd9.xdlCz09v6LKey79TIbtVlk-IS7uZH7ME8Loq1IsGO3I",
				sub
				);
